...
#packages = c("ade4", "AGHmatrix", "AnnotationDbi", "AnnotationHub", "BGLR", "candisc", "car", "ChIPseeker", "clusterProfiler", "CMplot", "corrgram", "corrplot", "data.table", "DESeq2", "detectRUNS", "doParallel", "DOSE", "dplyr", "DT", "emmeans", "enrichplot", "ensembldb", "ensemblVEP", "gdsfmt", "GENESIS", "GGally", "ggplot2", "ggrepel", "ggroups", "GOplot", "GOSemSim", "GPArotation", "gtools", "hierfstat", "lsmeans", "MeSHDbi", "meshes", "miscTools", "multcomp", "nnet", "org.Bt.eg.db", "orthopolynom", "outliers", "pcaMethods", "pheatmap", "plotly", "poolr", "psych", "qqman", "qvalue", "raster", "RColorBrewer", "ReactomePA", "readxl", "RegParallel", "rehh", "reshape2", "rgdal", "rlist", "rrBLUP", "rstatix", "SNPRelate", "snpStats", "sp", "stringr", "tidyr", "tidyverse", "VariantAnnotation", "vcfR", "vegan", "writexl", "WVPlots")
packages = c("ade4", "AGHmatrix", "AnnotationDbi", "AnnotationHub", "BGLR", "candisc", "car", "ChIPseeker", "clusterProfiler", "CMplot", "corrgram", "corrplot", "data.table", "DESeq2", "detectRUNS", "DO.db", "doParallel", "DOSE", "dplyr", "DT", "emmeans", "enrichplot", "ensembldb", "ensemblVEP", "gdsfmt", "GENESIS", "GGally", "ggplot2", "ggrepel", "ggroups", "GOSemSim", "GPArotation", "gtools", "hierfstat", "lsmeans", "MeSHDbi", "meshes", "miscTools", "multcomp", "nnet", "orthopolynom", "outliers", "pcaMethods", "pheatmap", "plotly", "poolr", "psych", "qqman", "qvalue", "raster", "RColorBrewer", "ReactomePA", "readxl", "RegParallel", "rehh", "reshape2", "rgdal", "rlist", "rrBLUP", "rstatix", "SNPRelate", "snpStats", "sp", "stringr", "tidyr", "tidyverse", "VariantAnnotation", "vcfR", "vegan", "writexl")
