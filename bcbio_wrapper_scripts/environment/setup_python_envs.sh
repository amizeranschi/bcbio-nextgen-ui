...
if [[ ! -d ${bcbio_install_path}/extra ]]; then
   ...
   ${bcbio_install_path}/extra/bin/extra_mamba install --name py3 --yes -c conda-forge -c bioconda kraken2 blast spades masurca quast \
   ...
   perl-bio-tools-run-alignment-tcoffee r-terra r-rgdal r-ragg r-ade4 r-aghmatrix bioconductor-annotationdbi bioconductor-annotationhub r-bedr r-bglr r-candisc \
